...
app.use('*', (req, res) => {
  const availableEndpoints = {
    ...
    availableRoutes: {
      ...
      admin: ['GET /admin/users (admin)', 'GET /admin/users/:userId/transactions (admin)', 'PUT /admin/users/:userId/role (admin)', 'DELETE /admin/users/:userId (admin)', 'GET /admin/stats (admin)'],
      health: ['GET /health']
    },
